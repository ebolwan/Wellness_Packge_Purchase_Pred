...
model_path = hf_hub_download(repo_id="bolwelwan/tourism-pkg-model", filename="best_tourism_pckg_model_v1.joblib")   # Replace <-------Hugging Face user ID --------->/<---model_repository_name--->", filename="<---model_filename---> with your Hugging Face username, model repository name, and model filename.
